...
RadioTower2F_MapEvents:
	...
	object_event  9,  2, SPRITE_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 4, TrainerGruntM5, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
	...
	object_event  9,  7, SPRITE_ROCKET_GIRL, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 4, TrainerGruntF2, EVENT_RADIO_TOWER_ROCKET_TAKEOVER
